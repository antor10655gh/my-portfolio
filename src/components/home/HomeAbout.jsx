...
const HomeAbout = () => {
  const handleClick = () => {
    ...
    link.href = resume;
    link.download = "Md_Abdul_Motaleb_Antor_Resume.pdf";
    link.click();
  };
        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-12 lg:gap-20">
          ...
          <div className="col-span-1">
            ...
            <p
              ...
              data-aos-easing="ease-in-out"
            >
              I specialize in both design and development, offering end-to-end
              solutions tailored to your needs. Whether you need a sleek,
              user-friendly interface or powerful backend functionality, I bring
              creativity and technical expertise together to turn your ideas
              into reality. From websites and applications to unique digital
              experiences, I ensure everything is crafted with precision,
