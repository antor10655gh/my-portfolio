...
const LetsDo = () => {
  ...
  return (
    <div className="w-full px-4 lg:px-0 py-[40px] md:py-[70px] lg:py-[100px]">
      <div className="w-full h-full px-4 lg:px-0 text-white overflow-hidden">
        <div
          className="max-w-screen-xl mx-auto h-full  flex flex-col justify-center rounded-md text-center py-[50px] md:py-[70px] lg:py-[100px]"
          style={{
